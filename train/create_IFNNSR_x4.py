...
train_net_path = 'train_x4.prototxt'
test_net_path = 'test_x4.prototxt'
train_data_path = 'examples/IFNNSR/train_data_x4.txt'
test_data_path = 'examples/IFNNSR/test_data_x4.txt'
