...
train_net_path = 'train_x2.prototxt'
test_net_path = 'test_x2.prototxt'
train_data_path = 'examples/IFNNSR/train_data_x2.txt'
test_data_path = 'examples/IFNNSR/test_data_x2.txt'
